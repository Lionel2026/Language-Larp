...
Written against `@clerk/expo` v3.7.x (July 2026). Peer requirements: Expo SDK >= 53 and < 56, React Native >= 0.73, React 18 or 19. If the project's Expo SDK or RN version is below the floor, upgrading the app comes before adding Clerk.
