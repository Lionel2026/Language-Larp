...
Appearance customization applies to the web SDK and prebuilt Clerk components. For Expo / React Native projects, use the native theming approach from the Expo skill instead of web-only `@clerk/ui` and CSS configuration.

### Component Customization Options

| Task | Documentation |
|------|---------------|
| Appearance prop overview (web SDK) | https://clerk.com/docs/nextjs/guides/customizing-clerk/appearance-prop/overview |
| Options (structure, logo, buttons) (web SDK) | https://clerk.com/docs/nextjs/guides/customizing-clerk/appearance-prop/layout |
| Themes (pre-built dark/light) (web SDK) | https://clerk.com/docs/nextjs/guides/customizing-clerk/appearance-prop/themes |
| Variables (colors, fonts, spacing) (web SDK) | https://clerk.com/docs/nextjs/guides/customizing-clerk/appearance-prop/variables |
| CAPTCHA configuration (web SDK) | https://clerk.com/docs/nextjs/guides/customizing-clerk/appearance-prop/captcha |
| Bring your own CSS (web SDK) | https://clerk.com/docs/nextjs/guides/customizing-clerk/appearance-prop/bring-your-own-css |

> **Expo / React Native guidance:** If the project uses `@clerk/expo`, prefer the Expo theme/plugin approach documented in `clerk-expo` rather than `@clerk/ui` or global CSS overrides. The web-only appearance APIs and `@clerk/ui` examples do not map directly to native Expo styling.
